...
"""
===================================
Markdown-to-Image Utilities
===================================

Convert Markdown into PNG images for notification channels that do not support Markdown.
Supports both wkhtmltoimage (imgkit) and markdown-to-file (m2f); the latter has better emoji support (Issue #455).
